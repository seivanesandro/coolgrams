...
export const publishPhoto = createAsyncThunk(
    ...
    async (photo, thunkAPI) => {
        ...
        const data =
            await photoService.publishPhoto(
                photo,
                token
            );
...
export const like = createAsyncThunk(
    ...
    async (id, thunkAPI) => {
        ...
        const data = await photoService.like(
            id,
            token
        );
